...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
        ...
        <!-- Sidebar Menu -->
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" @if($direction == "rtl")  style="padding: 0px !important;" @endif data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item  menu-open">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('tags.index') }}" class="nav-link @if(request()->is('admin/tags/*')) active @endif">
                                <i class="far fa-circle nav-icon"></i>
                                <p>{{ __('common.tags') }}</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('os-types.index') }}" class="nav-link @if(request()->is('admin/os-types/*')) active @endif">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('versions.index') }}" class="nav-link @if(request()->is('admin/versions/*')) active @endif">
                                <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('footers.index') }}" class="nav-link @if(request()->is('admin/footers/*')) active @endif">
                                <i class="far fa-circle nav-icon"></i>
                ...
                <li class="nav-item  @if(request()->is('admin/apps/*') || request()->is('admin/apps') ) menu-open @endif">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('apps.index') }}" class="nav-link @if(request()->is('admin/apps/*')) active @endif">
                                <i class="far fa-circle nav-icon"></i>
                                <p>{{ __('common.apps') }}</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('apps.create') }}" class="nav-link @if(request()->is('admin/apps/*')) active @endif">
                                <i class="far fa-circle nav-icon"></i>
